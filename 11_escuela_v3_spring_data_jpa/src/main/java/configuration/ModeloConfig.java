...
//si no lo cambiaramos , se pondria entitymanagerfactoryref="", y transactionmanagerref="" dentro de las llaves al lado de dao separado por una coma
@EnableJpaRepositories(basePackages = "dao")//para que sepa que instancie dao
...
public class ModeloConfig {	
	...
	//adaptador de Hibernate
		...
		//hay que poner entitymanagerfactory para que spring lo reconozca
		@Bean
		...
		//y en transaccion es igual, busca el nombre transactionmanager
		@Bean
